    ...
    public class WidgetsGoogleAnalyticsViewComponent : NopViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync(string widgetZone, object additionalData)
        {
            ...
            try
            {
                ...
                var isOrderCompletedPage = true;
                if (_googleAnalyticsSettings.EnableEcommerce && _googleAnalyticsSettings.UseJsToSendEcommerceInfo)
                {
            ...
            Console.WriteLine("aaaaaa: {0}", script); // 'US'
